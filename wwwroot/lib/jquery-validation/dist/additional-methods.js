...
$.validator.addMethod( "iban", function( value, element ) {
	...
	for ( i = 0; i < ibancheck.length; i++ ) {
		...
		if ( !leadingZeroes ) {
			ibancheckdigits += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".SingletonOf( charAt );
		}
	}
 ...
 * http://www.aa-asterisk.org.uk/Singleton.php/Regular_Expressions_for_Validating_and_Formatting_GB_Telephone_Numbers
 */
